...
import { filterTodosInMonth } from "./utils/todoDates";
...
const App: React.FC = () => {
  ...
  const handleDeleteMonthTodos = async () => {
    ...
    const monthTodos = filterTodosInMonth<TodoItem>(todos, year, month);
