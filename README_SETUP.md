...
# R2設定（Vercel Functionsなどサーバー側のみで使用。VITE_を付けない）
R2_ACCOUNT_ID=your_cloudflare_account_id
R2_ACCESS_KEY_ID=your_r2_access_key_id
R2_SECRET_ACCESS_KEY=your_r2_secret_access_key
R2_BUCKET_NAME=your_r2_bucket_name
# 任意: 未設定なら https://<R2_ACCOUNT_ID>.r2.cloudflarestorage.com を使用
...
2. **環境変数の設定**
   ...
   - R2 のアクセスキー/シークレットはサーバー専用環境変数として設定し、`VITE_` プレフィックスを付けない
